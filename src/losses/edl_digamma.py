"""EDL digamma loss for evidential deep learning.
...
@LOSS_REGISTRY.register("edl_digamma")
class EDLDigammaLoss:
    """EDL Bayes risk under cross-entropy loss (equation 4, Sensoy et al. 2018).
    ...
    def __call__(self, output, target):
        ...
        A = (y * (torch.digamma(S) - torch.digamma(alpha))).sum(dim=1, keepdim=True)
